...
[copyloaddate] [datetime] NULL CONSTRAINT [DF__Transacti__copyl__5DCAEF64] DEFAULT (getdate())
)
GO
ALTER TABLE [prodcopy].[Transaction__c] ADD CONSTRAINT [PK__Transact__3214EC0716EEAE12] PRIMARY KEY CLUSTERED  ([Id])
GO
