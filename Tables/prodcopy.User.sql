...
[copyloaddate] [datetime] NULL CONSTRAINT [DF__User__copyloadda__37A5467C] DEFAULT (getdate()),
...
GO
ALTER TABLE [prodcopy].[User] ADD CONSTRAINT [PK__User__3214EC071B0F0986] PRIMARY KEY CLUSTERED  ([Id])
GO
