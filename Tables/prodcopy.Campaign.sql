...
[copyloaddate] [datetime] NULL CONSTRAINT [DF__Campaign__copylo__6E01572D] DEFAULT (getdate())
)
GO
ALTER TABLE [prodcopy].[Campaign] ADD CONSTRAINT [PK__Campaign__3214EC0711D293FE] PRIMARY KEY CLUSTERED  ([Id])
GO
