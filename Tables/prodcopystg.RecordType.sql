...
[IsActive] [bit] NULL,
[copyloaddate] [datetime] NULL CONSTRAINT [DF__RecordTyp__copyl__2C3393D0] DEFAULT (getdate())
)
GO
ALTER TABLE [prodcopystg].[RecordType] ADD CONSTRAINT [PK__RecordTy__3214EC077BA01DF3] PRIMARY KEY CLUSTERED  ([Id])
GO
