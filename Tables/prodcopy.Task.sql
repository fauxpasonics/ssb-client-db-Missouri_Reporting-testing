...
[copyloaddate] [datetime] NULL CONSTRAINT [DF__Task__copyloadda__398D8EEE] DEFAULT (getdate()),
...
GO
ALTER TABLE [prodcopy].[Task] ADD CONSTRAINT [PK__Task__3214EC07AB00F8CC] PRIMARY KEY CLUSTERED  ([Id])
GO
