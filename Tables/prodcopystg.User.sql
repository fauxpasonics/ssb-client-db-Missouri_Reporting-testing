...
[copyloaddate] [datetime] NULL CONSTRAINT [DF__User__copyloadda__35BCFE0A] DEFAULT (getdate()),
[Full_User_ID__c] [nvarchar] (1300) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
[TM_User_ID__c] [nvarchar] (255) COLLATE SQL_Latin1_General_CP1_CI_AS NULL
)
GO
ALTER TABLE [prodcopystg].[User] ADD CONSTRAINT [PK__User__3214EC072FE0BCF4] PRIMARY KEY CLUSTERED  ([Id])
GO
