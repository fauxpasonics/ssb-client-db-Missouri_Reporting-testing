...
[copyloaddate] [datetime] NULL CONSTRAINT [DF__CampaignM__copyl__70DDC3D8] DEFAULT (getdate())
)
GO
ALTER TABLE [prodcopy].[CampaignMember] ADD CONSTRAINT [PK__Campaign__3214EC07CDA07CF3] PRIMARY KEY CLUSTERED  ([Id])
GO
